...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED2_Pin|REV_CH1_Pin|REV_CH2_Pin|REV_CH3_Pin
                          |REV_CH4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
                           PEPin */
  GPIO_InitStruct.Pin = LED2_Pin|REV_CH1_Pin|REV_CH2_Pin|REV_CH3_Pin
                          |REV_CH4_Pin;
